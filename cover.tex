...
\newcommand{\chinesethesistitle}{单环环流的大偏差与涨落定理} %中文论文标题
\newcommand{\englishthesistitle}{Large deviations and fluctuation theorems for cycle currents of monacyclic Markov chains} % 可用\uppercase：将英文标题字母全部大写；
