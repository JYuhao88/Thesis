...
\newcommand{\chinesethesistitle}{基于环流的大偏差理论和涨落定理的研究} %中文论文标题
\newcommand{\englishthesistitle}{Large deviations and fluctuation theorems for cycle currents} % 可用\uppercase：将英文标题字母全部大写；
...
\cauthor{姜瑜浩}
\csupervisor{贾晨\quad~助理教授}               %导师名字
%\cassosupervisor{}                        %若没有，则注释掉本行。
%\ccosupervisor{}                          %若没有，则注释掉本行。
\ccommitteechairman{\quad}        %答辩委员会主席
\creviewers{\quad}  % 评阅人
...
\classifiedindex{O242.1}  %国内图书分类号
\unidecimalclass{519.6}                 %UDC,没有，则为空。
\statesecrets{公开}                %秘密
\thesisnum{82817}                       %编号,没有，则为空。
